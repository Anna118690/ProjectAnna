 ...
 */
final class Version20200424092118 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD user_comment_id INT NOT NULL, ADD course_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP user_comment_id, DROP course_id');
    }
}
